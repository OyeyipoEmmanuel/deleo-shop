  ...
  return (
    <form>
      <div className="mt-6 flex flex-col space-y-4">
        ...
        {pathName === "/login" ? (
          <p className="text-center text-sm underline cursor-pointer font-semibold hover:text-purple-700 hover:transition-all duration-300">
            Forgot Password?
          </p>
        ) : (
          ""
        )}
        <ButtonUI btnName={props.buttonName} />
      </div>
      {pathName === "/login" ? (
        <>
